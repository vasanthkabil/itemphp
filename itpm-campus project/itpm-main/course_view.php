...
<div class="side_bar"></div>
    ...
    <div class="container-fluid" style="padding: 0px; margin: 0px width=1000px;">
        <div class="jumbotron">
            <h1 class="text-center bold">Course Management</h1>
                        ...
                        <div class="modal-content">
                                 ...
                                 <div class="row mx-sm-5 bg-info">
                                     ...
                                     <div class="col-md-6">
                                                ...
                                                <input type="text" name="session" id="session" placeholder="session *" class="form-control"><br>
                                        ...
                                        <!-- Modal body start -->
                                                ...
                                                <div class="row mx-sm-5 bg-primary mb-5" >
                                                                ...
                                                                <div class="col-md-6">
                                                                        ...
                                                                        <input type="text" name="edit_session" id="edit_session"   class="form-control"><br> 
